...
int main(int argc, char * argv[]) {
    ...
    const char *START_TEXT = "Hello User!  Welcome to jurasic's park pre-alpha version 0.0.3.256\n" \
    ...
    struct List * list = Storage_read(readFileName);
    cleanCanvas();
    ...
    while(key != 'q'){
        ...
        switch (key) {
            ...
            case '4':
                ...
                if(!Storage_write(saveFileName, list)){
