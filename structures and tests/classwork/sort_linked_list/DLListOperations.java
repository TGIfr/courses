 ...
 * @version 2016-12-11
 * 
 *          This is a program that contains operations on double-linked list.
 *          These operations are used in Sorter class to create, process and
 *          sort linked lists
 *
 */
public class DLListOperations {
	 ...
	 */
	public static int size(DLNode h) {
		int count = 0;
		while (h != null) {
			count++;
			h = h.next;
