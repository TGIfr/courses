...
public class BSTree<E extends Student> implements StudentDictionary<E> {
	...
	private void printTreeLevel(int LevelNumber, TreeNode currentNode, int CurrentLevelNumber){
		if(currentNode == null) {
			return;
		} else if(CurrentLevelNumber == LevelNumber){
			System.out.print(currentNode.getKey() + " ");
		} else {
			printTreeLevel(LevelNumber, currentNode.left, CurrentLevelNumber + 1);
			printTreeLevel(LevelNumber, currentNode.right, CurrentLevelNumber + 1);
		}
	}

	public void printTreeLevel(int LevelNumber){
		if(root == null) {
			System.out.println("TREE IS EMPTY");
			return;
		}
		System.out.println("Nodes on level " + LevelNumber);
		printTreeLevel(LevelNumber, root, 0);
		System.out.println();

//		Queue<TreeNode> currentLevel = new LinkedList<TreeNode>();
//		currentLevel.add(root);
//		printTreeLevel(LevelNumber, currentLevel, 0);
...
//
//			//prints nodes if level is correct
...
//		}
//
//		//in case if all tree was checked but needed level was not found
//		System.out.println("Level # " + LevelNumber + " not found");
	}
