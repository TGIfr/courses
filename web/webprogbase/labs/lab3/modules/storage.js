...
const Song = (id, name, author, length, date, info, img) => {
    return{
            name: name,
            author: author,
            length: length,
...
const create = function(id, name, author, length, date, info){
    let song = new Song(id, name, author, length, date, info);
...
const update = (name, author, length, id, date, info) => {
    let song = new Song(id, name, author, length, date, info);
