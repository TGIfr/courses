...
#include "EnemyShip_1.h"


// Sets default values
AEnemyShip_1::AEnemyShip_1()
{
...
void AEnemyShip_1::BeginPlay()
{
	...
	auto inst = AEnemyShip_1::GetOwner();
	auto rot = inst->GetActorRotation();
	Yaw = rot.Yaw;
	SpawnLocation = AEnemyShip_1::GetActorLocation();
...
void AEnemyShip_1::SpawnAnimation(float Lerp) {
...
float AEnemyShip_1::TakeDamage(float Damage, struct FDamageEvent const& DamageEvent, class AController* EventInstigator, class AActor* DamageCauser) {
...
// Called every frame
void AEnemyShip_1::Tick( float DeltaTime )
{
